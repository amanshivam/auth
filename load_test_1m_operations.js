...
// Configuration
const TOTAL_OPERATIONS = 1000000; // 1 million operations
const BATCH_SIZE = 1000; // Process in batches for memory efficiency
const CONCURRENT_BATCHES = 10; // Number of concurrent batches

// Test data generators
const tenants = ['tenant1', 'tenant2', 'tenant3', 'tenant4', 'tenant5'];
const groupNames = ['admin', 'user', 'manager', 'viewer', 'editor', 'moderator', 'supervisor', 'analyst'];
const resources = ['users', 'posts', 'comments', 'files', 'reports', 'analytics', 'settings', 'logs'];
const actions = ['read', 'write', 'delete', 'create', 'update', 'approve', 'reject'];
...
async function runLoadTest() {
    try {
        console.log('🚀 Starting 1M Operations Load Test');
        console.log('=' .repeat(80));
